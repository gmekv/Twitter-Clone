...
struct WelcomeView: View {
    ...
    private var loginText: AttributedString {
        var text = AttributedString("Have an account already? Log in")
        let blueColor = Color.twitterBlue
        
        if let loginRange = text.range(of: "Log in") {
            text[loginRange].foregroundColor = blueColor
        }
